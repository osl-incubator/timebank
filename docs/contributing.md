...
Report bugs at https://github.com/osl-incubator/timebank/issues.
...
TimeBank could always use more documentation,
whether as part of the official TimeBank docs,
in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at
https://github.com/osl-incubator/timebank/issues.
...
Ready to contribute? Here’s how to set up `timebank` for local development.

1.  Fork the `timebank` repo on GitHub.

2.  Clone your fork locally::

    $ git clone git@github.com:your_name_here/timebank.git

3.  Install your local copy into a virtualenv. Assuming you have
    virtualenvwrapper installed, this is how you set up your fork for
    local development::

    $ mkvirtualenv timebank
    $ cd timebank/
